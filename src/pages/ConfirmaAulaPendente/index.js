...
import {Container, ContainerGrande, ContainerButton, ButtonConfirmar, ButtonRecusar} from './styles';
    ...
    <Theme>
      <Background1 navigation={navigation} page={'PerfilProf2'}>
        ...
        <ContainerGrande>
          ...
          <ContainerGrande>
            <CustomText white>Nome: {user.firstName + ' ' + user.lastName}</CustomText>
          </ContainerGrande>
          <ContainerGrande>
